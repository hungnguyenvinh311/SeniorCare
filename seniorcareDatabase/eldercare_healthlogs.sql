...
CREATE TABLE `healthlogs` (
  ...
  `log_type` varchar(100) COLLATE utf8mb3_bin NOT NULL,
  `value` varchar(255) COLLATE utf8mb3_bin NOT NULL,
  `notes` text COLLATE utf8mb3_bin,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`log_id`),
  KEY `user_id` (`user_id`),
  CONSTRAINT `healthlogs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
LOCK TABLES `healthlogs` WRITE;
/*!40000 ALTER TABLE `healthlogs` DISABLE KEYS */;
/*!40000 ALTER TABLE `healthlogs` ENABLE KEYS */;
UNLOCK TABLES;
